...
public class GwendolenDeedImpl extends ASTWrapperPsiElement implements GwendolenDeed {

  public GwendolenDeedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GwendolenVisitor visitor) {
    visitor.visitDeed(this);
  }
  ...
  @Override
  @Nullable
  public GwendolenAction getAction() {
    return findChildByClass(GwendolenAction.class);
  }
  ...
  @Override
  @Nullable
  public GwendolenWaitfor getWaitfor() {
    return findChildByClass(GwendolenWaitfor.class);
  }
