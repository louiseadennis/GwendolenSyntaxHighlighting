...
public class GwendolenOperImpl extends ASTWrapperPsiElement implements GwendolenOper {

  public GwendolenOperImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GwendolenVisitor visitor) {
    visitor.visitOper(this);
  }
