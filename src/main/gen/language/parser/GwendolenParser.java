...
public class GwendolenParser implements PsiParser, LightPsiParser {
  ...
  private static boolean guard_atom_0_1_3(PsiBuilder b, int l) {
    ...
    r = r && guard_atom_0_1_3_2(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && guard_atom_0_1_3_4(b, l + 1);
    r = r && performative(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && fof_expr(b, l + 1);
    r = r && consumeToken(b, CLOSE);
  ...
  // (agentnameterm)
  private static boolean guard_atom_0_1_3_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "guard_atom_0_1_3_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = agentnameterm(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (agentnameterm COMMA)?
  private static boolean guard_atom_0_1_3_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "guard_atom_0_1_3_4")) return false;
    guard_atom_0_1_3_4_0(b, l + 1);
    return true;
  }

  // agentnameterm COMMA
  private static boolean guard_atom_0_1_3_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "guard_atom_0_1_3_4_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = agentnameterm(b, l + 1);
    r = r && consumeToken(b, COMMA);
